...
SELECT COUNT(*) FROM SUGGESTCOMMENT
(SELECT ROW_NUMBER() OVER(ORDER BY SUGCOMDATE) AS RNUM,
SUGCOMSEQ, SUGCOMCONTENT, TO_CHAR(SUGCOMDATE,'YYYY-MM-DD HH24:MI:SS') AS SUGCOMDATE, SUGCOMDEL, SUGGESTBBSSEQ FROM SUGGESTCOMMENT
ORDER BY RNUM DESC)
...
SUGCOMSEQ, SUGCOMCONTENT, TO_CHAR(SUGCOMDATE,'YYYY-MM-DD HH24:MI:SS') AS SUGCOMDATE, SUGCOMDEL, SUGGESTBBSSEQ FROM SUGGESTCOMMENT
ORDER BY RNUM DESC
(SELECT COUNT(*) FROM SUGGESTBBS WHERE SUGCOMDEL = 0) AS TOTALCNT) AA
WHERE AA.SUGCOMDEL = 0 

WHERE AA.SUGGESTBBSSEQ = 10040 AND AA.SUGCOMDEL = 0 
...
(SELECT COUNT(*) FROM SUGGESTCOMMENT WHERE SUGCOMDEL = 0) AS TOTALCNT,
SUGCOMSEQ, SUGCOMCONTENT, TO_CHAR(SUGCOMDATE,'YYYY-MM-DD HH24:MI:SS') AS SUGCOMDATE, SUGCOMDEL, SUGGESTBBSSEQ FROM SUGGESTCOMMENT
ORDER BY RNUM DESC) AA
WHERE SUGGESTBBSSEQ = 10021 AND AA.SUGCOMDEL = 0

SELECT AA.* FROM
(SELECT ROW_NUMBER() OVER(ORDER BY SUGCOMDATE DESC) AS RNUM,
(SELECT COUNT(*) FROM SUGGESTCOMMENT WHERE SUGCOMDEL = 0 AND SUGGESTBBSSEQ = 10084) AS TOTALCNT,
SUGCOMSEQ, SUGCOMCONTENT, TO_CHAR(SUGCOMDATE,'YYYY-MM-DD HH24:MI:SS') AS SUGCOMDATE, SUGCOMDEL, SUGGESTBBSSEQ 
 FROM SUGGESTCOMMENT
 WHERE SUGGESTBBSSEQ = 10084 AND SUGCOMDEL = 0 
 ORDER BY SUGCOMDATE DESC) AA
WHERE AA.RNUM > 1 AND 3 > AA.RNUM


SELECT AA.* FROM
(SELECT ROW_NUMBER() OVER(ORDER BY SUGCOMDATE DESC) AS RNUM,
(SELECT COUNT(*) FROM SUGGESTCOMMENT WHERE SUGCOMDEL = 0 AND SUGGESTBBSSEQ = 10021) AS TOTALCNT,
SUGCOMSEQ, SUGCOMCONTENT, TO_CHAR(SUGCOMDATE,'YYYY-MM-DD HH24:MI:SS') AS SUGCOMDATE, SUGCOMDEL, SUGGESTBBSSEQ 
 FROM SUGGESTCOMMENT
 WHERE SUGGESTBBSSEQ = #{suggestbbsseq} AND SUGCOMDEL = #{suggestbbsdel}
 ORDER BY SUGCOMDATE DESC) AA
